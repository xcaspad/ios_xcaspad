      ...
      {"ElseIf",0,0,0,T_ELIF},
      {"Elseif",0,0,0,T_ELIF},
      {"EndDlog",0,0,0,T_BLOC_END},
      {"EndFor",0,0,0,T_BLOC_END},
      {"EndFunc",0,0,0,T_BLOC_END},
      {"EndIf",0,0,0,T_BLOC_END},
      {"EndLoop",0,0,0,T_BLOC_END},
      {"EndPrgm",0,0,0,T_BLOC_END},
      {"EndTry",0,0,0,T_BLOC_END},
      {"EndWhile",0,0,0,T_BLOC_END},
      {"Endfor",0,0,0,T_BLOC_END},
      {"Endfunc",0,0,0,T_BLOC_END},
      {"Endif",0,0,0,T_BLOC_END},
      {"Endloop",0,0,0,T_BLOC_END},
      ...
      {"end_do",0,0,0,T_BLOC_END},
      {"end_for",0,0,0,T_BLOC_END},
      {"end_if",0,0,0,T_BLOC_END},
      {"end_proc",0,0,0,T_BLOC_END},
      {"end_while",0,0,0,T_BLOC_END},
      {"endfunc",0,0,0,T_BLOC_END},
